...
import com.example.racetracking.databinding.ActivityHhopeBinding
...
class HHopeActivity : AppCompatActivity() {
    lateinit var binding:ActivityHhopeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHhopeBinding.inflate(layoutInflater)
        ...
        RetrofitClient.getResponseFromApi().submitEvent(submitEvent).enqueue(object :
            ...
            override fun onResponse(call: Call<String>, response: Response<String>) {
                ...
                if (response.code()==200){
                    ...
                    submitItem.clear()
                    Toast.makeText(this@HHopeActivity,response.body().toString(), Toast.LENGTH_SHORT).show()
            ...
            override fun onFailure(call: Call<String>, t: Throwable) {
                Toast.makeText(this@HHopeActivity,t.localizedMessage, Toast.LENGTH_SHORT).show()
            }
