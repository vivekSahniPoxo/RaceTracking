...
import com.example.racetracking.databinding.EventAttandeeSprintResultBinding
...
class EventSPrintAdapter(private val mList: MutableList<RaceRegsModel.RaceRegsModelItem>) :
        RecyclerView.Adapter<EventSPrintAdapter.ViewHOlder>() {
