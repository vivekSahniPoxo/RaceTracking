...
class RaceTypeAdapter(val context: Context, var mList: List<RaceTypeDataModel.RaceTypeDataModelItem>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        item.cityName.text = mList[position].raceType
